...
SAVE_PATH = '/home/jmryan/teams/dsc-180a---a14-[88137]/bnpp_224_pandas/'
...
#             torch.save(im, file_path)
            ...
            if i % 500 == 0:
                print(i)
#    np.array(file_paths).tofile('/home/jmryan/teams/dsc-180a---a14-[88137]/df_bnpp_datapaths.csv', sep = ',')
    np.array(keys).tofile('/home/jmryan/teams/dsc-180a---a14-[88137]/df_bnpp_keys.csv', sep = ',')
#     pd.DataFrame({'filepath':file_paths, 'keys':keys}).to_pickle('/home/jmryan/teams/dsc-180a---a14-[88137]/df_bnpp_datapaths.pandas')
